...
describe('Test expenditure services', () => {
    describe('Test create service', () => {
        ...
        it('When everything goes well', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const expenditure = yield service.create(data.expenditure);
            expect(expenditure).to.be.deep.equal(data.createdExpenditureMock);
        }));
        it('When the category not exist in database', () => __awaiter(void 0, void 0, void 0, function* () {
            sinon.stub(categoryModel, 'readOne').resolves(null);
            try {
                yield service.create(data.expenditure);
            }
            catch ({ message }) {
    ...
    describe('Test read service', () => {
        ...
        it('When everything goes well', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const expenditure = yield service.read(data.queryExpenditure);
        ...
        it('When the category not exist in database', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            sinon.stub(categoryModel, 'readOne').resolves(null);
            try {
                yield service.read(data.queryExpenditure);
            }
            catch ({ message }) {
                expect(message).to.be.equal('Category not existent.');
            }
    ...
    describe('Test deleteOne service', () => {
        ...
        it('When everything goes well', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const expenditure = yield service.deleteOne(1);
            expect(expenditure).to.be.deep.equal(data.foundedExpenditure);
        }));
        it('When the expenditure not exist in database', () => __awaiter(void 0, void 0, void 0, function* () {
            sinon.stub(model, 'readOne').resolves(undefined);
            try {
                yield service.deleteOne(1);
            }
            catch ({ message }) {
    ...
    describe('Test readMonthExpense service', () => {
        ...
        it('When everything goes well', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const monthExpense = yield service.readMonthExpense(data.queryMonthExpenditure);
            expect(monthExpense).to.be.deep.equal(data.monthExpenseServiceResponse);
        }));
        it('When the value is null', () => __awaiter(void 0, void 0, void 0, function* () {
            sinon.stub(userModel, 'readOneById').resolves(userData.createdUserMock);
        ...
        it('When the user not exist in database', () => __awaiter(void 0, void 0, void 0, function* () {
            sinon.stub(userModel, 'readOneById').resolves(null);
            try {
                yield service.readMonthExpense(data.queryMonthExpenditure);
            }
            catch ({ message }) {
                expect(message).to.be.equal('User not exists.');
            }
