...
describe('Integration test salary', () => {
    describe('Test salary post route', () => {
        ...
        it('When everything goes well should return the new salary', () => __awaiter(void 0, void 0, void 0, function* () {
            // @ts-expect-error
    ...
    describe('Test salary get/:id route', () => {
        ...
        it('When everything goes well should return the new salary', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            prisma_1.prisma.user.findUnique = sinon.stub().resolves(userData.user);
            prisma_1.prisma.salary.findMany = sinon.stub().resolves(data.salaryArrayMock);
            const { status, body } = yield chai_1.default
                .request(app_1.default)
    ...
    describe('Test salary get/:id route', () => {
        ...
        it('When database returns an unexpected error', () => __awaiter(void 0, void 0, void 0, function* () {
            prisma_1.prisma.salary.findUnique = sinon.stub().throws('Inside server error');
            const { status, body: { message } } = yield chai_1.default
                .request(app_1.default)
                .patch('/salary/1')
                .send(data.updateSalaryData)
        ...
        it('When service returns an error', () => __awaiter(void 0, void 0, void 0, function* () {
            prisma_1.prisma.salary.findUnique = sinon.stub().resolves(null);
            const { status, body: { message } } = yield chai_1.default
                .request(app_1.default)
                .patch('/salary/1')
                .send(data.updateSalaryData)
