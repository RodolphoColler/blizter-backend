...
describe('Integration test user', () => {
    ...
    describe('Test patch /user/category route', () => {
        ...
        it('When everything goes well should the added category', () => __awaiter(void 0, void 0, void 0, function* () {
            prisma_1.prisma.category.findUnique = sinon.stub().resolves(data.createdCategoryMock);
    ...
    describe('Test get /user/category route', () => {
        (0, mocha_1.after)(() => { sinon.restore(); });
        const token = (0, jwt_1.jwtToken)(1);
        it('When everything goes well should return all categories', () => __awaiter(void 0, void 0, void 0, function* () {
            prisma_1.prisma.user.findUnique = sinon.stub()
