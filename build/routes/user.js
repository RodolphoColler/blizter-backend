...
router.patch('/category/:id', validateToken_1.default, controller.updateCategory);
router.post('/', validateUser_1.default, controller.create);
router.get('/category/:id', validateToken_1.default, controller.readCategory);
